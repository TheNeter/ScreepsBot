export class Traveler {
   ...
   * @returns {number}
   */
  public static travelInRoom(creep: Creep, posX:number, posY:number):number{
    return this.travelTo(creep,new RoomPosition(posX, posY, creep.room.name));
  }
  ...
  public static addStructuresToMatrix(room: Room, matrix: CostMatrix, roadCost: number): CostMatrix {
      ...
      room.find(FIND_MY_CONSTRUCTION_SITES).forEach((site:ConstructionSite)=> {
